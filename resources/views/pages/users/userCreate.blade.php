...
<section class="container my-5">
    <h2 class="text-center">Ajoutez un utilisateur</h2>
    ...
    <form class="d-flex flex-column  w-75 mt-5" enctype="multipart/form-data" action="{{route('users.store')}}" method="post">
        @csrf
        ...
        <input value="{{old('age')}}" type="number" min="12" max="100" name="age" id="age">
